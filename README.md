...
## WARNING: this is a fork to solve an issue
Angular 5 can´t compile with this library because dependencies on node types, so the current file was modified

dis/esm/IHubProtocol.d.ts
line 1: comment node dependency
